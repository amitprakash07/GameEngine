...
#define LOADGLFUNCTION( i_functionName, i_functionType )														\
	...
	LOADGLFUNCTION(glGenRenderbuffers, PFNGLGENRENDERBUFFERSPROC);
	LOADGLFUNCTION(glBindRenderbuffer, PFNGLBINDRENDERBUFFERPROC);
	LOADGLFUNCTION(glRenderbufferStorage, PFNGLRENDERBUFFERSTORAGEPROC);

	LOADGLFUNCTION(glGenFramebuffers, PFNGLGENFRAMEBUFFERSPROC);
	LOADGLFUNCTION(glBindFramebuffer, PFNGLBINDFRAMEBUFFERPROC);

	LOADGLFUNCTION(glFramebufferTexture1D, PFNGLFRAMEBUFFERTEXTURE1DPROC);
	LOADGLFUNCTION(glFramebufferTexture2D, PFNGLFRAMEBUFFERTEXTURE2DPROC);
	...
	LOADGLFUNCTION(glBufferSubData, PFNGLBUFFERSUBDATAPROC);
